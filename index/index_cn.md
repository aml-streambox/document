...
[🇺🇸 English Version]({{ '/index/index_en' | relative_url }})
...
参考[构建指南]({{ '/build-guide/build-guide_cn' | relative_url }})自行编译镜像。本项目不提供预编译镜像。
...
- [项目概览]({{ '/index/index_cn' | relative_url }}) - 本文档
- [构建指南]({{ '/build-guide/build-guide_cn' | relative_url }}) - 镜像编译说明
- [配置指南]({{ '/setup-guide/setup-guide_cn' | relative_url }}) - 镜像刷写与系统使用
- [驱动改动]({{ '/driver-modifications/driver-modifications_cn' | relative_url }}) - 内核与驱动修改详情
- [软件组件]({{ '/custom-software/custom-software_cn' | relative_url }}) - Cockpit 插件说明
- [源码参考]({{ '/source-code-reference/source-code-reference_cn' | relative_url }}) - 许可证与代码来源
- [常见问题与路线图]({{ '/faq-and-roadmap/faq-and-roadmap_cn' | relative_url }}) - 已知问题、FAQ 与开发计划
...
本项目采用 [MIT License]({{ '/LICENSE' | relative_url }}) 授权。

### 原始代码许可

本项目基于 Khadas VIM4 Yocto 版本。原始组件继承上游项目的相应许可证（内核及多数组件为 GPL/LGPL）。详情请参考[源码参考]({{ '/source-code-reference/source-code-reference_cn' | relative_url }})。
